...
public class HumanAgent : Agent
{
    ...
    public override void CollectObservations()
    {
        ...
        stringList.Add(currentFollowDist.ToString());
        stringList.Add(laneCOG.ToString());
        stringList.Add(currentLane.ToString());
        Debug.Log("CURRENT LANE == " + currentLane.ToString());
        stringList.Add(currentSpeed.ToString());
        stringList.Add(goalSpeed.ToString());
        ...
        //using(StreamWriter sw = File.AppendText(@"C:\Users\jsben\OneDrive\Documents\UnityFiles\sensorLog.csv"))
        //{
        //    sw.WriteLine(String.Join(",", stringList));
        //}
