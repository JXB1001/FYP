...
public sealed class ControllerPID:MonoBehaviour
{
    private double processVariable = 0;

    public ControllerPID(double GainProportional, double GainIntegral, double GainDerivative, double OutputMax, double OutputMin)
    {
